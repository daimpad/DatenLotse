...
| 🪪 | **Lizenz-Wegweiser** | Zwei Fragen (Namensnennung? national/international?) führen deterministisch zur passenden **offenen** Lizenz (DL-DE-BY/-Zero, CC-BY, CC0) inkl. Begründung und amtlichem Link; auf Wunsch für alle Datensätze ohne Lizenz übernehmbar – mit Hinweis, dass NC/ND/Share-Alike nicht als offen gelten |
...
| 📚 | **Wissens- & Methodik-Center** | In-App-Nachschlagewerk: Glossar der zentralen Open-Data-Begriffe, Rechtsgrundlagen-Bibliothek (Bund/EU mit amtlichen Links) und die Reifegrad-Modelle hinter dem Kompass – durchsuchbar, lokal, keine Rechtsberatung |
